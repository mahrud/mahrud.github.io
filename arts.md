...
{% comment %}
Things to add:
- Silviana's 3D artwork: https://silviana.org/work_blog/septych_of_sectics/
- Statues in libraries, in Stonybrook, etc.
- Plaster statues on random displays
- Giant siderules?
{% endcomment %}

Mathematics is often presented as a sequence of Definitions, Propositions, Theorems, and Conjectures.
...
> ![](../static/spectres.png){: style="width: 400px; display:block; margin: auto;"}
...
*"And since geometry is the right foundation of all painting, I have decided to teach its<br />
...
## [The Geometry Center](http://www.geom.uiuc.edu/)
 Speaking of animating mathematics, I was delighted to learn about the Geometry Center, where spectacular videos like [_Outside In_](https://www.youtube.com/watch?v=OI-To1eUtuU) were created, and sad to learn that it used to be located at the University of Minnesota before being closed in 1998 -- long before I arrived. An [anthology of videos](https://www.cs.ubc.ca/~tmm/gc/) by the center is graciously provided by Professor Tamara Munzner, who previously worked there.

> ![](../static/outsidein.png){: style="width: 400px; display:block; margin: auto;"}
*"Outside In (1994) showcases William Thurston's approach to turning a sphere inside out."*
{: style="text-align: center"}

## [Thurston's Simple Closed Curvy Mural](https://www.math.stonybrook.edu/~moira/papers/ThurstonCurve/ThurstonCurve.pdf)
 Another wonderfully mathematical piece of artwork which I wish had survived is this mural on a wall in Evans hall in Berkeley by William Thurston and Dennis Sullivan from 1971. I am somewhat tickled that the project was "in response to a little flurry with administration sactions of some sort when John Rhodes painted the wall outside his office, I think with a political slogan related to one of the issues of the times (Vietnam war, invasion of Cambodia, People's Park?)," according to [Sullivan](https://www.ams.org/notices/200303/what-is-web.pdf). Dr. Marissa Kawehi Loving wrote about the mathematics of this mural [here](https://twitter.com/MarissaKawehi/status/1307101429052715009).

> ![](../static/ThurstonCurve.jpg){: style="width: 400px; display:block; margin: auto;"}
*"The 'wall curve painting,' two meters high and four meters wide, dated and signed,<br />
lasted on that Berkeley wall with periodic restoration for almost four decades"*
{: style="text-align: center"}

## [Anatoly Fomenko's Extraordinary Artwork](https://virtualmathmuseum.org/mathart/ArtGalleryAnatoly/Anatolyindex.html)
 I first came across Fomenko's artwork when a friend told me about "Homotopical Topology" by Fomenko and Fuchs. While he had some .. uhh, [odd?](https://en.wikipedia.org/wiki/New_chronology_(Fomenko)) .. opinions, I really like his artistic style!

<center>
<blockquote style="display:block; margin: auto;">
  <img src="../static/Fomenko-000.jpg" width="120px">
  <img src="../static/Fomenko-001.jpg" width="120px">
  <img src="../static/Fomenko-002.jpg" width="120px">
  <img src="../static/Fomenko-003.jpg" width="120px">
  <img src="../static/Fomenko-004.jpg" width="120px">
  <em>"How to unclasp one's fingers in three-dimensional Euclidean space;" a tutorial in 4 acts.</em>
</blockquote>
</center>
...
[tablets]: https://collections.louvre.fr/ark:/53355/cl010185652
[Shush]: https://en.wikipedia.org/wiki/Susa
